...
|-------|------------|--------|
| **Python** | 4+ yrs | Data science, ML, backends |
| **JavaScript** | 3+ yrs | ES6+, full-stack |
| **TypeScript** | 2+ yrs | Typed apps & APIs |
| **C#** | 3+ yrs | .NET ecosystem, OOP |
| **SQL** | 4+ yrs | Analysis, optimization, design |
...
| Skill | Experience | Notes |
|-------|------------|--------|
| **TensorFlow** | 3+ yrs | Training, deployment |
| **PyTorch** | 3+ yrs | Research & production models |
| **Keras** | 3+ yrs | Rapid deep learning |
| **Scikit-learn** | 3+ yrs | Classical ML, evaluation |
| **Hugging Face** | 2+ yrs | Transformers, datasets, hub |
| **LangChain** | 1+ yr | LLM apps, RAG |
| **LangGraph** | 1+ yr | Multi-agent workflows, graphs |
| **MCP Servers** | 1+ yr | Tooling & AI integrations |
| **Vertex AI** | 1+ yr | Google Cloud ML at scale |
| **MLflow** | 1+ yr | Experiments, registry, deployment |
| **OpenCV** | 2+ yrs | Computer vision, tracking |
| **Qdrant** | 1+ yr | Vector DB for RAG |
| **Vapi** | 1+ yr | Voice AI, phone & web agents |
| **Retell AI** | 1+ yr | Low-latency voice, speech-to-speech |
| **Eleven Labs** | 1+ yr | TTS, voice design, streaming |
...
| Skill | Experience | Notes |
|-------|------------|--------|
| **Pandas** | 4+ yrs | Cleaning, analysis at scale |
| **NumPy** | 4+ yrs | Numerics, linear algebra |
| **Apache Spark** | 2+ yrs | Distributed big data |
| **Redis** | 2+ yrs | Cache, queues, realtime |
| **Power BI** | 2+ yrs | Dashboards, DAX, BI |
| **Seaborn** | 3+ yrs | Statistical plots |
| **Matplotlib** | 4+ yrs | Custom figures & reporting |
...
| Skill | Experience | Notes |
|-------|------------|--------|
| **React** | 2+ yrs | Hooks, components, patterns |
| **Next.js** | 2+ yrs | App Router, full-stack React |
| **HTML5** | 4+ yrs | Semantic, accessible markup |
...
| Skill | Experience | Notes |
|-------|------------|--------|
| **Node.js** | 2+ yrs | APIs, microservices |
...
| Skill | Experience | Notes |
|-------|------------|--------|
| **Azure** | 3+ yrs | ML, Cognitive Services, App Service |
...
| Skill | Experience | Notes |
|-------|------------|--------|
| **Jupyter Notebooks** | 4+ yrs | EDA, reproducible ML |
| **SharePoint** | 2+ yrs | Collaboration, integrations |
| **QuickBooks** | 3+ yrs | Finance workflows, APIs |
| **N8n** | 1+ yr | Automation for AI & APIs |
| **Microsoft Graph** | 2+ yrs | M365 mail, files, directory |
